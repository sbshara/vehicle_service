...
<div class="w3-container">
    ...
    <h3 class="w3-bottombar"><i class="fa fa-tags fw"></i> &nbsp;Service Categories</h3>
    <?php if($page->total_pages() > 1){ echo $show_records; } ?>

    <!--<div id="loader"></div>-->
    <table class="w3-table w3-striped w3-bordered w3-border w3-hoverable w3-white">

        <th class="w3-black">ID</th>
        <th class="w3-black">Category Name</th>
        <th class="w3-black">Category Description</th>
        ...
        <tr>
            ...
            <td><a class="w3-hover-blue" href="ucategory.php?id=<?php echo $category->id; ?>"><i class="fa fa-pencil-square-o"></i></a></td>
            <td><a class="w3-hover-red" href="dcategory.php?id=<?php echo $category->id; ?>" onclick="return confirm('Delete this user record?');"><i class="fa fa-remove"></i></a></td>
        </tr>
        <?php
            }
        ?>
   ...
   <a class="w3-btn w3-hover-green" href="ncategory.php"> <i class="fa fa-plus"></i>&nbsp; &nbsp;New Service Category</a>
  </div>
  <hr>
