...
<div class="w3-container">
    ...
    <h3 class="w3-bottombar"><i class="fa fa-users fw"></i> &nbsp;Users</h3>
    <?php
    ...
    <table class="w3-table w3-striped w3-bordered w3-border w3-hoverable w3-white">
        ...
        <th class="w3-black">User ID</th>
        <th class="w3-black">User Name</th>
        <th class="w3-black">Full Name</th>
        <th class="w3-black">User Group</th>
        ...
        ?>
        <tr>
            <td><a href="user.php?id=<?php echo $agent->id; ?>"><?php echo $agent->id; ?></a></td>
            ...
            <td><a class="w3-hover-blue" href="uuser.php?id=<?php echo $agent->id; ?>"><i class="fa fa-pencil-square-o"></i></a></td>
            <td><a class="w3-hover-red" href="duser.php?id=<?php echo $agent->id; ?>" onclick="return confirm('Delete this user record?');"><i class="fa fa-remove"></i></a></td>
        </tr>
        <?php
            }
        ?>
   ...
   <a class="w3-btn w3-hover-green" href="nuser.php"> <i class="fa fa-plus"></i>&nbsp; &nbsp;New User</a>
  </div>
  <hr>
