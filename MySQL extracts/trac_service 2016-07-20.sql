...
(1, 1, 'New Agent', 'new_agent.php', 2),
(3, 1, 'List Agents', 'agents.php', 2),
(4, 2, 'New Truck', 'new_truck.php', 2),
(5, 2, 'List Trucks', 'trucks.php', 2),
(6, 3, 'New Service Entry', 'new_service.php', 2),
...
CREATE TABLE `trucks` (
  ...
  `time_interval_id` int(12) NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=latin1;
...
INSERT INTO `trucks` (`id`, `plate`, `vin`, `brand`, `model`, `mileage_interval_id`, `time_interval_id`) VALUES
