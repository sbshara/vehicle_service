...
--
-- Host: 127.0.0.1
-- Generation Time: Jul 20, 2016 at 02:38 PM
...
INSERT INTO `modules` (`id`, `module_name`, `visibility`) VALUES
(1, 'Agents', 2),
(2, 'Trucks', 2),
(3, 'Services', 2);
...
(1, 1, 'New Agent', 'nuser.php', 2),
(3, 1, 'List Agents', 'agents.php', 2),
(4, 2, 'New Truck', 'ntruck.php', 2),
(5, 2, 'List Trucks', 'trucks.php', 2),
(6, 3, 'New Service Entry', 'nservice.php', 2),
...
INSERT INTO `users` (`id`, `username`, `hashed_password`, `agent_name`, `email`, `user_group`) VALUES
(1, 'shiblie', 'secretpassword', 'shiblie bshara', 'shb182@hotmail.com', 1),
(19, 'sbshara', 'password', 'shiblie bshara', 'shiblie@menaa.com', 1),
(20, 'fouad.assad', 'lolo1234', 'Fouad', 'fouad.assad@hotmail.com', 1),
(21, 'xvxxv', '1111', 'svxvsxv', 'xcxvxv@rr.com', 3);
...
trucks.id, trucks.plate, trucks.vin, trucks.brand, trucks.model, mileage_interval.mileage_interval, date_interval.date_interval, tbl1.max_mileage
--
-- CREATE A VIEW WITH FULL VEHICLE DETAILS --
--
SELECT trucks.id, trucks.plate, trucks.vin, trucks.brand, trucks.model, mileage_interval.mileage_interval, date_interval.date_interval, tbl1.max_mileage FROM trucks LEFT JOIN mileage_interval ON trucks.mileage_interval_id = mileage_interval.id LEFT JOIN date_interval ON trucks.date_interval_id = date_interval.id LEFT JOIN (SELECT truck_id, MAX(mileage) AS max_mileage FROM truck_mileage GROUP BY truck_id) as tbl1 ON trucks.id = tbl1.truck_id
